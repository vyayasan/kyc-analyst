...
```
CORRECT:
/home/your-username/Documents/KYC_Cases/2026/02_February/Smith_John_20260211/Audit_Trail.txt
...
### Excel Cell Value Compatibility

When writing Excel files via MCP file tools, avoid using `===` in cell values. Use parentheses, dashes, or colons instead:
