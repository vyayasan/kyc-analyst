...
**KNOWN BUG:** Do NOT use Unicode characters (checkmarks, arrows) with Helvetica font in fpdf2. Use ASCII alternatives like `[OK]`, `[X]`, `[->]`.

**fpdf2 Usage Notes:**
- Use `new_x="LMARGIN", new_y="NEXT"` instead of deprecated `ln=True`
- Professional color scheme: headers #1F4E78, green badges #C6EFCE, red badges #FFC7CE
- Footer with case reference, version, page numbers
...
**KNOWN BUG:** Do NOT put `===` characters in any Excel cell value when using Desktop Commander -- it serializes as `[object Object]`. Use openpyxl directly instead.
